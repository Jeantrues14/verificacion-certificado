...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="assets/img/logoap.png">
  <link rel="icon" type="image/png" href="assets/img/logoap.png">
  <title>
    Panel de Cursos | Acreditaciones Profesionales
  </title>
  <!--     Fonts and icons     -->
...
?>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Cursos</h6>
        </nav>
    ...
    <!-- Modal Modificar-->
    <div class="modal fade" id="modalModificarCourse" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
          <form action="./componentes/modificar-curso.php" method="post">
            <input type="hidden" name="id" id="modalModificarId">
            <div class="form-group">
              <label for="modalModificarNombre">Nombre del curso</label>
              <input type="text" class="form-control" id="modalModificarCurso" name="nombre">
            </div>           
            <div class="modal-footer" style="padding-bottom: 0 !important;">
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="componentes/eliminar-curso.php" class="btn btn-danger" id="btnConfirmarDeleteCourse">Confirmar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="importModal" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="componentes/importar-cursos.php" method="post" enctype="multipart/form-data">
            <div class="modal-header">
              <h4 class="modal-title">Importar cursos</h4>
            </div>
            <div class="modal-body">
              <div class="form-group">
                <label for="csvFile">Selecciona un archivo CSV</label>
                <input type="file" name="csvFile" id="csvFile" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>
              </div>
            </div>
            <div class="modal-footer" style="padding-bottom: 0 !important;">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                ...
                <div class="col-lg-8 col-5" style="text-align: right;">
                  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalAgregar">Agregar Curso</button>
                  <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#importModal">Importar Usuarios</button>
                </div>
              </div>
            </div>
                  ...
                  <tbody>
                    <?php                    
                      foreach ($cursos as $curso) {
                        ...
                        echo '<td><div class="d-flex px-3 py-1"><div class="d-flex flex-column justify-content-center" style="text-transform: capitalize;">' . $curso['nombre_curso'] . '</div></div></td>';                        
                        echo '<td><div class="d-flex px-3 py-1"><div class="d-flex">';
                        echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalModificarCourse" data-id="' . $curso['id'] . '" data-nombre="' . $curso['nombre_curso'] . '">
                        Modificar
                      </button>&nbsp;';
                        echo '<button type="button" class="btn btn-danger btn-delete" id="btn-delete-course" data-bs-toggle="modal" data-bs-target="#modalConfirmarEliminacion" data-id="' . $curso['id'] . '">Eliminar</button>';
                        echo '</div></div></td>';
                        echo '</tr>';
                      }
                    ?>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12 mb-lg-0 mb-4">
              ...
              Copyright © <script>
                ...
                <a href="#" class="font-weight-bold" target="_blank">Acreditaciones Profesionales</a>
