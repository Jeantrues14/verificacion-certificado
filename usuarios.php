...
<?php
  ...
  $resultusers = mysqli_query($conexion, 'SELECT * FROM usuarios');

  $usuarios = $resultusers->fetch_all(MYSQLI_ASSOC);
...
?>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
          ...
          <div class="modal-body">
            ...
            <form method="post" action="./componentes/agregar-usuario.php">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="modalAgregarNombre" name="nombre" required>
              </div>
              <div class="form-group">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="componentes/eliminar-usuario.php" class="btn btn-danger" id="btnConfirmarEliminacionUser">Confirmar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="importModal" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="componentes/importar-usuarios.php" method="post" enctype="multipart/form-data">
            <div class="modal-header">
  ...
  <script src="assets/js/functions-user.js"></script>
    <script>
