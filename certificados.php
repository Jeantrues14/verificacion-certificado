...
<head>
  ...
  <title>
    Panel de Certificados | Acreditaciones Profesionales
  </title>
  <!--     Fonts and icons     -->
...
?>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Certificados</h6>
        </nav>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="modalAgregarUsuario">Estudiante</label>
                <select name="usuario_id" id="modalAgregarUsuario" class="form-control">
                  <?php
    ...
    <div class="modal fade" id="modalModificarCertificados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form action="./componentes/modificar-certificado" method="post" id="formModificarCertificado">
            ...
            <div class="form-group">
              ...
              <select name="usuario_id" id="modalModificarUsuario" class="form-control">
                <?php
                foreach ($usuarios as $usuario) {
                  echo "<option value='" . $usuario['id'] . "'>" . $usuario['nombre'] . " " . $usuario['apellido'] . "</option>";
                }
            ...
            <div class="form-group">
              <label for="modalModificarCurso">Curso</label>
              <select name="curso_id" id="modalModificarCurso" class="form-control">
                <?php
                foreach ($cursos as $curso) {
                  echo "<option value='" . $curso['id'] . "'>" . $curso['nombre_curso'] . "</option>";
                }
            ...
            <div class="card-header pb-0">
              <div class="row">
                ...
                <div class="col-lg-8 col-5" style="text-align: right;">
                  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalAgregar">Agregar Certificado</button>
                </div>
              </div>
            </div>
               ...
               <?php
                ...
                <tbody>';                   
                      foreach ($certificados as $certificado) {
                        echo '<tr>';
                        echo '<td><div class="d-flex px-3 py-1"><div class="d-flex flex-column justify-content-center">' . $certificado['id'] . '</div></div></td>';
